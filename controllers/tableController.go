...
func GetTables() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Ensure you are querying the correct collection (e.g., tableCollection)
		...
		if err = result.All(ctx, &allTables); err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occurred while decoding table items"})
			return
		}
